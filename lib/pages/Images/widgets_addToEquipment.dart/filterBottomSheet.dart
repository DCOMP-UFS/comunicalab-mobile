...
const MaterialColor customPrimarySwatch = MaterialColor(0xFF000080, <int, Color>{
  50: Color(0xFFEAE3F3),
...
Future filterBottomSheet<Map>({@required BuildContext context, String name, String category}) async {
