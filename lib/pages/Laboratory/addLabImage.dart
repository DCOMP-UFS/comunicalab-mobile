...
//TODO o filtro nessa tela não está sendo aplicado
  @override
  Widget build(BuildContext context) {
    final mediaQuery = MediaQuery.of(context).devicePixelRatio *
        ...
        body: SingleChildScrollView(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                TicketCardLaboratoryImage(
                    _ticket1, "Laboratório de Hardware", "Departamento"),
                TicketCardLaboratoryImage(
                    _ticket1, "Laboratório de Hardware 2", "Departamento"),
                TicketCardLaboratoryImage(
                    _ticket2, "Laboratório de Hardware", "Departamento"),
                TicketCardLaboratoryImage(
                    _ticket2, "Laboratório de Hardware", "Departamento"),
                TicketCardLaboratoryImage(
                    _ticket3, "Laboratório de Hardware", "Departamento"),
              ],
            ),
          ),
        )));
