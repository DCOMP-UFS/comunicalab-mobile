  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
          ...
          primaryTextTheme: Theme.of(context).primaryTextTheme.apply(bodyColor: Color(0xFFFFFFFF)),
          accentTextTheme: Theme.of(context).primaryTextTheme.apply(bodyColor: Color(0xFF000080))
      ),
      home: MultiBlocProvider( //Conforme surgir a necessidade, adicionar blocProviders aqui
        providers: [
          BlocProvider<QrBloc>(
            create: (context) => QrBloc(),
          ),
        ],
        child: HomePage(), //Depois alterar para direcionar para a tela de login
      )
    );
  }
}
